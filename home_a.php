...
echo "<div style='text-align: center; font-size: 35px; font-weight: bold; font-family: cursive; color:rgb(13, 152, 161);'>
      ...
      <div id="hero-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        <div class="carousel-item active">
          ...
          <div class="container">
            ...
            <a href="about_a.php" class="btn-get-started">Read More</a>
          </div>
