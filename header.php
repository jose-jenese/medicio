    ...
    <div class="branding d-flex align-items-center">
      ...
      <div class="container position-relative d-flex align-items-center justify-content-end">
        ...
        <nav id="navmenu" class="navmenu">
          <ul>
            <li><a href="home.php" class="<?php echo $orgRoute == "home" ? 'active' : '' ?>">Home </a></li>
            <li><a href="about.php" class="<?php  echo $orgRoute == "about" ? 'active' : '' ?>">About</a></li>
       
            <li><a href="faq.php"  class = "<?php  echo $orgRoute == "faq" ? 'active' : '' ?>">FAQs</a></li>
            
            <li><a href="contact.php"  class = "<?php  echo $orgRoute == "contact" ? 'active' : '' ?>">Contact</a></li>
          </ul>
          <i class="mobile-nav-toggle d-xl-none bi bi-list"></i>
        </nav>

        <a class="cta-btn" href="signup.php">SignUp</a>
